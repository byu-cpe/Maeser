...
byu_simple_rag: CompiledGraph = get_simple_rag(vectorstore_path="example/vectorstores/maeser", vectorstore_index="index", memory_filepath="chat_logs/byu.db", system_prompt_text=byu_prompt)
