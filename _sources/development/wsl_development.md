...
1. Install the [**VS Code WSL Extension**](https://marketplace.visualstudio.com/items?itemName=ms-vscode-remote.remote-wsl).  
2. Open an Ubuntu shell, navigate to the project folder, and run the following command:
