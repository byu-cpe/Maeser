...
In order for Discord to talk with your script, you need to have a discord bot token. This token will go under the section in your `config.yaml` in the `v2` folder.
