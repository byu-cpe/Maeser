...
> **Note:** The following guide is for the Flask and terminal implementations of Maeser. For detailed instructions on setting up the Maeser Discord handler, see [Setting up a Discord Bot](../development/discord.md).
