...
- **Customize the Web Interface:** Change the parameters of the **AppManager** in your Flask script to change the color and icons used by the web interface. (For more information on the AppManager class, refer to the source code documentation in the [**maeser.flask_app.blueprints**](../autodoc/maeser/maeser.flask_app.blueprints.rst) module.)
