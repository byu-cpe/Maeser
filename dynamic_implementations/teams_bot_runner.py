...
'''
This is some experimental code generated by AI. This is a handler script 
for teams, which uses the microsoft azure bot service. In order to get it working,
It will have to go through this service.'''
